...
<div class="m-auto h-1/2 w-full px-1">
    ...
    <form method="POST" action="{{ route('login') }}" x-data="loginForm({ csrfToken: '{{csrf_token()}}' })" class="p-3 shadow-xl shadow-red-300 rounded">
        {{-- @csrf --}}
        <div>
        ...
        <div class="flex items-center justify-end my-4"> 
            <button class="app-btn app-btn-primary">Log in</button>
        </div>
