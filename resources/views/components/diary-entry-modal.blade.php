    ...
    <div class="p-4 w-full">
        <div class="bg-white rounded-lg shadow">
            ...
            <div class="p-6 text-slate-700">
                ...
                <template x-for="star of Object.keys(stars)">
                    <svg xmlns="http://www.w3.org/2000/svg" @click="stars[star] = !stars[star]" class="h-8 w-8 inline-block cursor-pointer" :fill="stars[star] ? '#facc15' : 'none'" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
