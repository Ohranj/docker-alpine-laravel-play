...
<div x-data class="mt-3 p-3">
    <div class="h-[400px] w-[300px] mx-auto mb-6 flex flex-col rounded shadow-lg 
        ...
        <svg @click="$store.userCard.followUserPressed({{$newUser}})" xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 absolute top-8 right-8 cursor-pointer" viewBox="0 0 20 20" fill="currentColor">
