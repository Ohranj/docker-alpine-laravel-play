...
<div x-data x-cloak x-show="$store.userCard.showMessageModal" class="flex m-auto items-center fixed inset-0 z-50 h-full w-full sm:app-sm-modal">
    <div class="p-4 w-full">
        <div class="bg-white rounded-lg shadow">
            ...
            <div class="p-6">
                <div x-cloak x-show="$store.userCard.showMemberMessageFormError && !$store.userCard.memberMessagedSuccess" class="text-red-500 text-center sm:w-3/4 mx-auto mb-2">
